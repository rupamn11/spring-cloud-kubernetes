...
-------
    git clone https://github.com/rupamn11/spring-cloud-kubernetes.git
...
--------------
    docker build -t rupamn11/kubernetes-configmap-reload .
...
-----------
    docker push rupamn11/kubernetes-configmap-reload
